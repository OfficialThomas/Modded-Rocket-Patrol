class Menu extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.audio('sfx_explosion5', './assets/assets_explosion_5.wav');
    ...
    create() {
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'Move the mouse ←→ to move the rocket', menuConfig).setOrigin(0.5);
        this.add.text(game.config.width/2, game.config.height/2 + borderUISize + borderPadding, 'Left click on the mouse to fire', menuConfig).setOrigin(0.5);
