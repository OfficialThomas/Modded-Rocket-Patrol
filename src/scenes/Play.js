class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.ship02 = new Scoutship(this, game.config.width + borderUISize*3, borderUISize*5 + borderPadding*2, 'scout', 0, 50, 5000).setOrigin(0,0);
        this.ship03 = new Spaceship(this, game.config.width, borderUISize*6 + borderPadding*4, 'spaceship', 0, 10, 3000).setOrigin(0, 0);
